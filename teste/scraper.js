...
async function xvideosDownloader(url) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, criador: '+55 94 9147-2796', resultado: {titulo: dados1.name, desc: dados1.description, thumb: dados1.thumbnailUrl[0], link: dados1.contentUrl}})
    })
    .catch(e => {
      reject(e)
    });
